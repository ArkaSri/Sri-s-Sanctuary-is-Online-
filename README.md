...
## Features
- **High-Speed Inference:** Powered by Groq leveraging `openai/gpt-oss-120b`.
- **Adaptive Safety Guardrails:** Intelligent handling that delivers warm, sophisticated problem-solving for respectful users, while firmly checking and neutralizing toxic or disrespectful inputs.
